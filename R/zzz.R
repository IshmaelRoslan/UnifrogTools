.onAttach <- function(libname, pkgname) {
  ...
  update_geom_defaults("point", list(color = unifrog_colors("lightgrey")))
  update_geom_defaults("col", list(fill = unifrog_colors("lightgrey")))
  update_geom_defaults("bar", list(fill = unifrog_colors("lightgrey")))
  update_geom_defaults("line", list(color = unifrog_colors("lightgrey"),
                                    linewidth = 1.5))
}
