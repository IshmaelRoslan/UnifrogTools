...
scale_color_unifrog_c <-
  function(palette = "seq_iridescent",
           discrete = FALSE,
           reverse = FALSE,
           aesthetics = "color",
           ...) {
...
qual_bright <-
  unikn::newpal(
    col = c("#4477AA", "#66CCEE", "#228833", "#CCBB44", "#EE6677", "#AA3377", "#BBBBBB"),
...
qual_vibrant <-
  unikn::newpal(
    col = c("#0077BB", "#33BBEE", "#009988", "#EE7733", "#CC3311", "#EE3377", "#BBBBBB"),
    names = c("blue", "cyan", "teal", "orange", "red", "magenta", "grey"),
    as_df = F
  )
...
qual_muted <-
  unikn::newpal(
    col = c("#332288", "#88CCEE", "#44AA99", "#117733", "#999933", "#DDCC77", "#CC6677", "#882255", "#AA4499"),
    names = c(
...
qual_mc <-
  unikn::newpal(
    col = c("#EECC66", "#EE99AA", "#6699CC", "#997700", "#994455", "#004488"),
    names = c("light yellow", "light red", "light blue", "dark yellow", "dark red", "dark blue"),
    as_df = F
  )
...
qual_pale <-
  unikn::newpal(
    ...
    names = c(
      "pale blue", "pale cyan", "pale green", "pale yellow",
      "pale red", "pale grey"
    ),
    as_df = F
  )
...
qual_light <-
  unikn::newpal(
    ...
    names = c(
      "light blue", "orange", "light yellow", "pink", "light cyan",
